  ...
  return (
    <>
      ...
      <div className="mb-6 lg:mb-10 pl-2">
        <div className="text-[72px] md:text-[42px] lg:text-[52px] 2xl:text-[72px] leading-[0.8] font-black text-[#EF4444] tracking-tighter">
          {currentDay}
        </div>
        <div className="text-xl md:text-sm lg:text-base 2xl:text-xl font-bold text-gray-800 mt-2">
          {currentMonthYear}
        </div>
      </div>
