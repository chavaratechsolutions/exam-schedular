...
export default function CalendarHeader({
  ...
  return (
    <header className="flex h-[70px] sm:h-[80px] md:h-[80px] lg:h-[100px] items-center justify-between px-4 md:px-6 lg:px-8 bg-white md:pr-10">
      {/* Mobile Menu Toggle */}
      ...
      {/* Left: View Toggles */}
      <div className="hidden md:flex bg-[#F5F6F8] rounded-[16px] lg:rounded-[24px] p-1 lg:p-1.5">
        <button 
          className="px-4 py-2 lg:px-6 lg:py-2.5 rounded-[12px] lg:rounded-[20px] text-xs lg:text-sm font-bold text-gray-500 hover:text-gray-800 transition-colors"
        >
          Year
        </button>
        <button 
          onClick={() => onViewChange("month")}
          className={`px-4 py-2 lg:px-6 lg:py-2.5 rounded-[12px] lg:rounded-[20px] text-xs lg:text-sm font-bold transition-all ${
            view === "month" 
